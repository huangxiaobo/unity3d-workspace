...
public class msg_sc_player_vel : msg_handler{
	public ushort type = Events.MSG_SC_PLAYER_VEL;
	public int uid;
	public float x;
	public float y;
	public float z;
...
public class msg_cs_player_vel : msg_handler{
	public ushort type = Events.MSG_CS_PLAYER_VEL;
	public int uid;
	public float x;
	public float y;
	public float z;

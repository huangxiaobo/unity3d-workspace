...
public class msg_sc_player_pos : msg_handler{
	public ushort type = Events.MSG_SC_PLAYER_POS;
	public int uid;
	public float x;
	public float y;
	public float z;
...
public class msg_cs_player_pos : msg_handler{
	public ushort type = Events.MSG_CS_PLAYER_POS;
	public int uid;
	public float x;
	public float y;
	public float z;

...
public class msg_sc_player_mov : msg_handler{
	public ushort type = Events.MSG_SC_PLAYER_MOV;
	public int uid;
	public float x;
	public float y;
	public float z;
...
public class msg_cs_player_mov : msg_handler{
	public ushort type = Events.MSG_CS_PLAYER_MOV;
	public int uid;
	public float x;
	public float y;
	public float z;
